...
export type JwtKmsPsProviderConfig<
...
> extends JwtAbstractProvider<JwtAlgorithmsPSSchema, EnabledAlgorithms, PrivateClaimsSchema, IssuerClaim, SubjectClaim, AudienceClaim, JtiClaim> {
  ...
  constructor(private config: JwtKmsPsProviderConfig<EnabledAlgorithms, PrivateClaimsSchema, IssuerClaim, SubjectClaim, AudienceClaim, JtiClaim>) {
    super({
